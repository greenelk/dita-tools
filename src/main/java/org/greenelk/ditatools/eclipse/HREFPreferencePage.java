...
public class HREFPreferencePage extends PreferencePage implements
		IWorkbenchPreferencePage {

	public static final String PAGE_ID = "org.greenelk.ditatools.hrefpage";

	// The list that displays the current file filters
	...
	protected void performDefaults() {
		fileFilterList.setItems(DITAToolsPlugin.getDefault()
				.getDefaultHREFFileFilterPreference());
	}
	...
	public boolean performOk() {
		DITAToolsPlugin.getDefault().setHREFFileFilterPreference(
